...
public class LingshichukuEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public LingshichukuEntity() {
		
	}
	
	public LingshichukuEntity(T t) {
		try {
	 ...
	 * 设置：出库价格
	 */
	public void setChukujiage(Double chukujiage) {
		this.chukujiage = chukujiage;
	}
	/**
	 * 获取：出库价格
	 */
	public Double getChukujiage() {
		return chukujiage;
	}
	/**
	 * 设置：出库时间
